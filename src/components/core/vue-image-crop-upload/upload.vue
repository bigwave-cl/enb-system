<template>
	<ask-modal 
		...
		:show-footer = "false"
		:before-close="off"
		class="custom-enb-confirm vue-image-crop-upload">
	<!-- <div class="vue-image-crop-upload" v-show="value"> -->
		<div class="vicp-wrap">
			<div class="vicp-title">
				<div class="vicp-text">{{title}}</div>
				<div class="vicp-close-icon" @click="off">
...
<script>
/*
 *	插件源文件Demo地址:https://github.com/dai-siki/vue-image-crop-upload
 * 	感谢作者无私的开源
 */
'use strict';
...
.ask-modal-box.vue-image-crop-upload{
	.ask-modal-body{
		padding: 0;
	}
}
